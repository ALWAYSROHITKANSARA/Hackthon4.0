...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <meta http-equiv="x-ua-compatible" content="ie=edge">
         <title>App Landing - Blood Donation</title>
    ...
    <body>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="index_app_landing.php">App Landing</a></li>
                ...
                <div class="row g-hor-centered-row--md g-margin-t-30--xs g-margin-t-20--sm">
                    <div class="col-lg-6 col-sm-6 g-hor-centered-row__col g-text-center--xs g-text-left--md g-margin-b-60--xs g-margin-b-0--md">
                        <div class="s-promo-block-v1__square-effect g-margin-b-60--xs">
                            <h1 class="g-font-size-32--xs g-font-size-45--sm g-font-size-50--lg g-color--white">To Join With<br>The Blood Aadhaar</h1>
                            <p class="g-font-size-20--xs g-font-size-26--md g-color--white g-margin-b-0--xs">Everyone can Become a<br>SAVIOR.</p>
                        </div>
                        ...
                        <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                            <form class="center-block g-width-350--xs g-bg-color--white-opacity-lightest g-box-shadow__blueviolet-v1 g-padding-x-40--xs g-padding-y-60--xs g-radius--4">
                                ...
                                <div class="g-margin-b-30--xs">
                                    <input type="number" class="form-control s-form-v3__input" placeholder="* Aadhaar No.">
                                </div>
                                <div class="g-margin-b-30--xs">
                                    <input type="number" class="form-control s-form-v3__input" placeholder="* Mobile No.">
                                </div>
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">About Blood_aadhaar</h2>
                    <p class="g-font-size-18--sm">One of the key reasons has been the absenceof centerlized blood donor registry and unique donor identification program.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5">
                <div class="col-sm-5 col-sm-push-7 g-hor-centered-row__col">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Production</p>
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Blood Bank</h2>
        ...
        <section class="s-video__bg" data-vidbg-bg="mp4: include/media/mp4_video.mp4, webm: include/media/webm_video.webm, poster: include/media/fallback.jpg" data-vidbg-options="loop: true, muted: true, overlay: false">
            <div class="container g-position--overlay g-text-center--xs">
                <div class="g-padding-y-50--xs g-margin-t-50--xs g-margin-t-100--sm g-margin-b-100--xs g-margin-b-250--md">
                    <h2 class="g-font-size-36--xs g-font-size-50--sm g-font-size-60--md g-color--white">Give The Gift Of LIFE:</h2>
                    <h2 class="g-font-size-36--xs g-font-size-50--sm g-font-size-60--md g-color--white">Donate Blood.</h2>
                </div>
            </div>
        </section>
        <!-- End Video -->
            ...
            <div class="row g-margin-b-30--xs">
                <div class="col-sm-4">
                    <div class="g-margin-t-20--md g-margin-b-40--xs">
                        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Blood Bank</p>
                        <h2 class="g-font-size-32--xs g-font-size-36--md">Projects</h2>
                        <p>We know that life is important so give blood us<br> and save a LIFE.</p>
                    </div>
                </div>
                    ...
                    <div id="js__grid-portfolio-gallery" class="s-portfolio__paginations-v1 cbp">
                        ...
                        <div class="s-portfolio__item cbp-item motion graphic">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                <div class="g-margin-b-25--xs">
                                    ...
                                    <p class="g-color--white-opacity">by TeamALways Inc.</p>
                                </div>
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/04.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Team Always">
                        ...
                        <div class="s-portfolio__item cbp-item logos graphic">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                <div class="g-margin-b-25--xs">
                                    ...
                                    <p class="g-color--white-opacity">by TeamAlways.</p>
                                </div>
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/09.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by TeamAlways.">
                                            <i class="ti-fullscreen"></i>
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="s-portfolio__item cbp-item logos motion">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                ...
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/05.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by TeamAlways.">
                                            <i class="ti-fullscreen"></i>
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="s-portfolio__item cbp-item graphic">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                ...
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/06.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by TeamAlways.">
                                            <i class="ti-fullscreen"></i>
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="s-portfolio__item cbp-item logos">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                ...
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/07.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by TeamAlways.">
                                            <i class="ti-fullscreen"></i>
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="s-portfolio__item cbp-item motion graphic">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                ...
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    <li>
                                        <a href="img/970x647/08.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by TeamAlways.">
                                            <i class="ti-fullscreen"></i>
                                        </a>
                                    </li>
                                    <li>
        ...
        <div class="g-bg-color--primary-to-blueviolet-ltr">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--xsm">
                <div class="g-margin-b-60--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1 g-color--white">Join Over 1000+ Donors</h2>
                </div>
                <div class="row">
        ...
        <div class="g-hor-divider__dashed--sky-light g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="container g-text-center--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-50--xs">Testimonials</p>
