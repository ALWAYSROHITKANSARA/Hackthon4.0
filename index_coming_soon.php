...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Coming_soon - Blood Donation</title>
        <!-- Web Fonts -->
            ...
            <div class="container js__ver-center-aligned">
                <div class="g-text-center--xs">
                    <div class="g-margin-t-40--xs g-margin-b-60--xs g-margin-b-80--sm">
                        <h1 class="g-font-size-32--xs g-font-size-50--sm g-font-size-60--md g-margin-b-30--xs">Blood Donation Camp <br>Coming Soon...</h1>
                        ...
                        <div class="row g-margin-b-80--xs">
                            ...
                            <div class="col-sm-4 col-xs-6 g-full-width--xs">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control s-form-v4__input" placeholder="Your Mobile">
                                </div>
                            </div>
                        </div>
