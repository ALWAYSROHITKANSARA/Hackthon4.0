...
<html lang="en" class="no-js">
    ...
    <Script>
        function chechdata(){
            var le=document.getElementById("num1").value.length;
            {
                alert("Your massage has successfully gone and come help fast..thanks");
            }
        }
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="index_coming_soon.php">Coming Soon</a></li>
                        </ul>
                        <!-- End Menu List -->
            ...
            <div class="container js__ver-center-aligned">
                <div class="g-text-center--xs">
                    <div class="g-margin-t-40--xs g-margin-b-60--xs g-margin-b-80--sm">
                        <h1 class="g-font-size-32--xs g-font-size-50--sm g-font-size-60--md g-margin-b-30--xs">Emergency</h1>
                        ...
                        <div class="row g-margin-b-80--xs">
                            <div class="col-sm-4 col-sm-offset-2 col-xs-6 g-full-width--xs g-margin-b-30--xs g-margin-b-0--md">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control s-form-v4__input" placeholder="Your Adharnumber">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 col-xs-6 g-full-width--xs">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control s-form-v4__input" placeholder="Your Mobile">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-6 g-full-width--xs">
                                <div class="input-group">
                                    ...
                                    <input type="mail" class="form-control s-form-v4__input" placeholder="Your email">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-6 g-full-width--xs">
                                <div class="input-group">
                                    ...
                                    <input type="passward" class="form-control s-form-v4__input" placeholder="Your passward">
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="text-uppercase s-btn s-btn--md s-btn--dark-brd g-radius--50 g-padding-x-50--xs g-margin-b-20--xs"onclick="chechdata()">Submit</button>
                    </form>
                </div>
            </div>
        </div>
