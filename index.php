...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>The Blood Aadhaar - Blood Donation</title>
        <!-- Web Fonts -->
    ...
    <body>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_app_landing.php">App Landing</a></li>

                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_portfolio.php">Blogs</a></li>
                            
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_events.php">Events</a></li>
                            
                            

                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_clinic.php">Clinic</a></li>
                            
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_coming_soon.php">Coming Soon</a></li>
                        </ul>
                        <!-- End Menu List -->
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/121.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">"30 Minutes"<br>Is All To save a life! </h1>
                        </div>
                ...
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/123.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <div class="g-margin-b-30--xs">
            ...
            <a href="emergency.php" class="s-scroll-to-section-v1--bc g-margin-b-15--xs">
                <span class="g-font-size-18--xs g-color--white ti-angle-double-down"></span>
                <p class="text-uppercase g-color--white g-letter-spacing--3 g-margin-b-0--xs"><b><u>Emergency</u></b></p>
            </a>
        </div>
        <!--========== END SWIPER SLIDER ==========-->
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="redly g-text-center--xs g-margin-b-100--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Welcome to The Blood_AaDHar</p>
                <h2 class="g-font-size-32--xs g-font-size-36--md">We Create Beautiful Experiences <br> To Give The Gift of Life.</h2>
            </div>
                    ...
                    <div class="clearfix">
                        <div class="g-media g-width-30--xs">
                            <div class="wow fadeInDown" data-wow-duration=".3" data-wow-delay=".4s">
                                <i class="g-font-size-28--xs g-color--red ti-package"></i>
                            </div>
                        </div>
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Endless Donors</h3>
                            <p class="g-margin-b-0--xs">Give blood everyone can become a savior.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                    <div class="clearfix">
                        <div class="g-media g-width-30--xs">
                            <div class="wow fadeInDown" data-wow-duration=".3" data-wow-delay=".5s">
                                <i class="g-font-size-28--xs g-color--red ti-star"></i>
                            </div>
                        </div>
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Powerful Performance</h3>
                            <p class="g-margin-b-0--xs">By using aadhaar help to get infromation though aadhaar.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="clearfix">
                        <div class="g-media g-width-30--xs">
                            <div class="wow fadeInDown" data-wow-duration=".3" data-wow-delay=".6s">
                                <i class="g-font-size-28--xs g-color--red ti-panel"></i>
                            </div>
                        </div>
                        <div class="g-media__body g-padding-x-20--xs">
        ...
        <!-- Parallax -->
        <div class="js__parallax-window" style="background: url(img/1920x1080/22.jpg) 70% 0 no-repeat fixed;">
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Culture</p>
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">About</h2>
                        </div>
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md"> Blood_Aadhaar</h2>
                        </div>
                    </div>
                    <div class="daynmic col-md-4 col-md-offset-1">
                        <p class="g-font-size-18--xs">One of the key reasons has been the absenceof centerlized blood donor registry and unique donor identification program. </p>
                        <p class="g-font-size-18--xs">with no centeralized blood donor registry in place,blood donors found receive during their previous donation at a particular blood bank again end up donating at maltiple blood donation camps. </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 g-promo-section__img-right--lg g-bg-position--center g-height-100-percent--md js__fullwidth-img">
                <img class="img-responsive" src="img/970x970/44.gif" alt="Image">
            </div>
        </div>
        <!-- End Culture -->

        <!-- Subscribe -->
        <div class="js__parallax-window" style="background: url(img/1920x1080/2122.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-margin-b-80--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-color--white"><b>Join Over 1000+ Donors</b></h2>
                </div>
                <div class="row">
        ...
        <div class="container g-padding-y-80--xs">
            <div class="g-text-center--xs g-margin-b-40--xs">
                <h2 class="g-font-size-32--xs g-font-size-36--md g-color--red">Events</h2>
            </div>
            <div class="s-portfolio">
                <div id="js__filters-portfolio-gallery" class="s-portfolio__filter-v1 cbp-l-filters-text cbp-l-filters-center">
                    ...
                    <div data-filter=".graphic" class="s-portfolio__filter-v1-item cbp-filter-item">Jaipur</div>
                    <div data-filter=".logos" class="s-portfolio__filter-v1-item cbp-filter-item">Ajmer</div>
                    <div data-filter=".motion" class="s-portfolio__filter-v1-item cbp-filter-item">Jodhpur</div>
                </div>
            </div>
        </div>
            ...
            <div id="js__grid-portfolio-gallery" class="cbp">
                ...
                <div class="s-portfolio__item cbp-item logos motion">
                    ...
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            ...
                            <p class="g-color--white-opacity">by Always.</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="img/970x647/05.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Always.">
                ...
                <div class="s-portfolio__item cbp-item graphic">
                    ...
                    <div class="s-portfolio__caption-hover--cc">
                        <div class="g-margin-b-25--xs">
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
                            <p class="g-color--white-opacity">by Team Always.</p>
                        </div>
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="img/970x647/06.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by Always">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item motion graphic">
                    ...
                    <div class="s-portfolio__caption-hover--cc">
                        ...
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="img/970x647/08.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by ALWAYS.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item logos graphic">
                    ...
                    <div class="s-portfolio__caption-hover--cc">
                        ...
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="img/970x647/09.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by ALWAYS.">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
                ...
                <div class="s-portfolio__item cbp-item motion graphic">
                    ...
                    <div class="s-portfolio__caption-hover--cc">
                        ...
                        <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                            <li>
                                <a href="img/970x647/04.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by ALWAYS">
                                    <i class="ti-fullscreen"></i>
                                </a>
                            </li>
                            <li>
        ...
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-text-center--xs g-margin-b-80--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Blog</p>
            ...
            <div class="row">
                <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                    ...
                    <article>
                        ...
                        <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2">News</p>
                            <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="http://www.friends2support.org/inner/about/blood.aspx">Friends 2 Support</a></h3>
                            <p>With over 1,50,000 registered voluntary blood donors, they have saved more than 2,00,000 lives so far, which is incredible.</p>
                        </div>
                    </article>
                    <!-- End News -->
                </div>
                <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                    ...
                    <article>
                        ...
                        <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2">News</p>
                            <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="http://www.bloodconnect.org/">Blood Connect</a></h3>
                            <p>A youth led initiative, Blood Connect had its inception at IIT Delhi in 2010. What started as a  compassion of four students, led hundreds others to join them in their crusade of eradicating the blood shortage in the country. </p>
                        </div>
                    </article>
                    <!-- End News -->
                </div>
                <div class="col-sm-4">
                    ...
                    <article>
                        ...
                        <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2">News</p>
                            <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="http://www.sankalpindia.net/">Sankalp India Foundation</a></h3>
                            <p>Founded over a decade ago, Sankalp India Foundation is a Bangalore based NGO serving people throughout India. </p>
                        </div>
                    </article>
                    <!-- End News -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--lg">
                        <div class="g-text-center--xs">
                            ...
                            <h4 class="g-font-size-18--xs g-color--white">Blood Sample</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--lg">
                        <div class="g-text-center--xs">
                            ...
                            <div class="center-block g-hor-divider__solid--white g-width-40--xs g-margin-b-25--xs"></div>
                            <h4 class="g-font-size-18--xs g-color--white">Organization</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--sm">
                        <div class="g-text-center--xs">
                            ...
                            <div class="center-block g-hor-divider__solid--white g-width-40--xs g-margin-b-25--xs"></div>
                            <h4 class="g-font-size-18--xs g-color--white">Hospitals</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6 g-full-width--xs">
                        <div class="g-text-center--xs">
                            ...
                            <div class="center-block g-hor-divider__solid--white g-width-40--xs g-margin-b-25--xs"></div>
                            <h4 class="g-font-size-18--xs g-color--white">Faster Deliver</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--red g-letter-spacing--2 g-margin-b-25--xs">Feedback</p>
                ...
                <form>
                    ...
                    <div class="g-text-center--xs">
                        <button type="submit" class="text-uppercase s-btn s-btn--md s-btn--red-bg g-radius--50 g-padding-x-80--xs">Submit</button>
                    </div>
                </form>
            </div>
        </div></div>
        ...
        <section class="s-google-map">
            <img src="img/1920x1080/Untitled.png" width="100%"> 
        </section>
        <!-- End Google Map -->
        <!--========== END PAGE CONTENT ==========-->
            ...
            <div class="g-hor-divider__dashed--white-opacity-lightest">
                <div class="container g-padding-y-80--xs">
                    <div class="row">
                        ...
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://twitter.com/login?lang=en">Twitter</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://www.facebook.com/">Facebook</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://www.instagram.com/accounts/login/">Instagram</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://www.youtube.com/">YouTube</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-2 g-margin-b-40--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                <li><a class="g-font-size-15--xs googleapis g-color--white-opacity" href="">Subscribe to Our Newsletter</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="">Privacy Policy</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity">Terms &amp; Conditions</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-md-offset-2 col-sm-5 col-sm-offset-1 s-footer__logo g-padding-y-50--xs g-padding-y-0--md">
                            <h3 class="g-font-size-18--xs g-color--white">The Blood Aadhaar</h3>
                            <p class="g-color--white-opacity">One of the key reasons has been the absenceof centerlized blood donor registry and unique donor identification program.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    ...
                    <div class="col-xs-6 g-text-right--xs">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--red">Always Team - Theme Powered by:
    <a href="#">always@info.com </a> </p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
