                            ...
                            <div class="collapse navbar-collapse s-header-v2__navbar-collapse" id="nav-collapse">
                                <ul class="s-header-v2__nav">
                                    ...
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        <a href="index.php" class="dropdown-toggle s-header-v2__nav-link -is-active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="g-font-size-10--xs g-margin-l-5--xs ti-angle-down"></span></a>
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="index.php" class="s-header-v2__dropdown-menu-link">Home</a></li>
                                            
                                            <li><a href="index_app_landing.php" class="s-header-v2__dropdown-menu-link">App Landing</a></li>
                                            <li><a href="index_events.php" class="s-header-v2__dropdown-menu-link">Events</a></li>
                                            <li><a href="index_clinic.php" class="s-header-v2__dropdown-menu-link -is-active">Clinic</a></li>
                                        </ul>
                                    </li>
                                    <!-- End Home -->
                                    ...
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        ...
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            ...
                                            <li><a href="index_coming_soon.php" class="s-header-v2__dropdown-menu-link">Coming Soon</a></li>
                                        </ul>
                                    </li>
                                    <!-- End Pages -->
                                    ...
                                    <li class="s-header-v2__nav-item"><a href="index_portfolio.php" class="s-header-v2__nav-link">Portfolio</a></li>
                    ...
                    <div class="container g-ver-center--xs">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <a href="emergency.php" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50 g-padding-x-50--xs">Emergency</a>
                            </div>
                        </div>
                    </div>
                </div>
