...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <meta http-equiv="x-ua-compatible" content="ie=edge">
                <title>FAQ - Blood Donation</title>
    ...
    <body>
        ...
        <div id="js__scroll-to-section" class="g-container--md g-padding-y-80--xs g-padding-y-125--sm">
            ...
            <div class="row g-margin-b-50--xs">
                <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--sm">
                    <p>An organisation with primary focus on bringing voluntary blood donors closer to those who need them. The idea is to facilitate a requestor to approach a donor in his/her required location and time. <br>We are also trying to provide as many resources as we can for rural child education. Anyone who believes in our principles and has desire to serve humanity are welcome to join us as everyone's friends.</p>
                ...
                <div class="col-sm-6">
                    <p>Currently, we are supporting the people whose information was provided to always by one of our volunteers. If you are willing to join us, then provide us the information, so that we can get together and create an idea to support those who need us.</p>
                    <p>We started always as we desired to make a difference in the society. We have come together with the mindset that, even the smallest of help means a lot to someone. If you think like us then please join us.</p>
                </div>
            </div>
                            ...
                            <div class="cbp-item buying">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h2 class="s-faq-grid__title">What is The Blood_Aadhaar ?</h2>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            ...
                                            <br>
                                            We are also trying to provide as many resources as we can for rural child education. Anyone who believes in our principles and has desire to serve humanity are welcome to join us as everyone's friends.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item community">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h3 class="s-faq-grid__title">Who are these friends ?</h3>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            
                                                A friend is one of us, in us. "A friend is somoeone who is there for you when he'd rather be somewhere else" - Unknown
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item buying">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">So what are we(The Blood_Aadhaar) planning to do with this website ?
</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            Through this website, we are bridging the gap between blood donors and requestors. We display the donor details of those registered with us, to be useful for people who are searching for blood donors. 
                                            We also support child education and helpless people by providing them as many resources as we can.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">What are my duties as a member of The Blood_Aadhaar..</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            Whenever you hear from someone who needs blood, you should be able to support them by providing them with information of blood donors available in The Blood_Aadhaar.</br>
                                            You can search for blood donors in the required locality and provide their contact details to the requestor, so the requestor can contact a blood donor directly.
                            ...
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How long does a blood donation take?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            The entire process takes about one hour and 15 minutes; the actual donation of a pint of whole blood unit takes eight to 10 minutes.</br>
                            ...
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How long will it take to replenish the pint of blood I donate?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            The plasma from your donation is replaced within about 24 hours. Red cells need about four to six weeks for complete replacement.</br> That’s why at least eight weeks are required between whole blood donations.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="cbp cbp-l-grid-faq js__grid-faq">
                            <div class="cbp-item account">
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            It is important that your The Blood_Aadhaar Account has a secure, private password at all times.
                                            <br>
                                            Sign in to your The Blood_Aadhaar Account via the button at the top right of the Blood_Aadhar.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How often can I donate blood?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                            ...
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">Does the The Blood_Aadhaar pay blood donors?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                            ...
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">Can I donate blood for myself?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            The Blood_Aadhaar is not a legal body which is qualified to give you advice on these matters.  Any suggestions on this page are to be considered general and not specific to your situation. When sending legal documentation or taking any form of legal action, we recommend you consult with a legal professional. We can take no responsibility for the repercussions of following the suggestions in this document.
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-60--xs">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1">Join Over 1000+ Donors</h2>
            </div>
            <div class="row">
